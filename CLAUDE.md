...
├── shell/              # Zsh configs (.zshrc, .zshenv, .p10k.zsh)
...
### Shell Configuration (Zim Framework)

Uses **Zim** (not Oh-My-Zsh) with Powerlevel10k theme. Key configurations:
...
- **PATH additions**: Homebrew, Cargo, uv, pyenv, Go, local bin, custom cliffy
